...
import { LogOut, ShoppingCart, Package, BarChart3, Truck, Users, ClipboardList, Settings, Brain, FileText } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/remitos', icon: FileText, label: 'Remitos' },
  { to: '/insights', icon: Brain, label: 'IA Insights' },
];
